...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<state_machine>, [">= 0.9.0"])
      s.add_runtime_dependency(%q<blockenspiel>, ["= 0.4.1"])
      s.add_runtime_dependency(%q<activesupport>, ["= 2.3.8"])
    else
      s.add_dependency(%q<daemons>, [">= 1.0.9"])
      s.add_dependency(%q<blankslate>, [">= 2.1.2.2"])
      s.add_dependency(%q<state_machine>, [">= 0.9.0"])
      s.add_dependency(%q<blockenspiel>, ["= 0.4.1"])
